 ...
 * 
 * The Parser builds a parse tree from the source code. Each grammar rule
 * corresponds to a function. Each function returns a lexeme representing the 
 * root of the parse tree for a given rule.
 * 
 * 
 */
...
public class Parser {
	...
	private boolean check(String type) {
		if (currentlexeme.getType().equals(type))
			return true;
		else
			return false;
	}
